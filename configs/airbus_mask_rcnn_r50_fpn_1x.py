...
#TODO calculate this shit from dataset
img_norm_cfg = dict(
    mean=[123.675, 116.28, 103.53], std=[58.395, 57.12, 57.375], to_rgb=True)

#TODO build Dataset class from this shit
data = dict(
    imgs_per_gpu=2,
    workers_per_gpu=2,
    train=dict(
    ...
    test=dict(
        ...
        test_mode=True))
# optimizer
#TODO figure out learning rate...one GPU should be 0.002
